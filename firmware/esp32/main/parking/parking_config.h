...
/**
 * Parking slot hardware configuration.
 *
 ...
 *                          per-slot thresholds; this file)
 *   parking_settings.h   - algorithm/system defaults (scan interval, filter
 *                          alpha, confirmation counts, task knobs)
