 ...
 *         or an error from the underlying GPIO driver.
 */
 ...
 * @return ESP_OK on success, ESP_ERR_INVALID_ARG on bad arguments, or
 *         ESP_ERR_TIMEOUT if no ECHO pulse arrives within the timeout window.
 */
